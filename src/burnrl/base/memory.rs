...
use burn::tensor::{BasicOps, Tensor, TensorKind, backend::Backend};
use rand::Rng;
...
mod tests {
    use burn::{
        backend::NdArray,
        tensor::{Int, Shape, Tensor, backend::Backend},
    };

    use crate::burnrl::{
        base::{
            Action, ElemType, Memory, Snapshot, State, environment::Environment, get_batch,
            sample_indices,
        },
        utils::{
